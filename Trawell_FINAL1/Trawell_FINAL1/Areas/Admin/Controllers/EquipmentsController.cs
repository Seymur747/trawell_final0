...
namespace Trawell_FINAL1.Areas.Admin.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,equipment_Name,equpment_Price")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,equipment_Name,equpment_Price")] Equipment equipment)
        {
            if (ModelState.IsValid)
            {
